...
var colorPalette = [linear-gradient(to right, #360033, #0b8793);, "#fffff", "#003d3d", "#000000"];
...
function preload() {
	audio = loadSound("audio/28marzo14.mp3");
}
...
function draw() {
	...
	for (i = 0; i < pieces; i += 0.1) {
		...
		strokeWeight(0.2);
		polygon(mapMid + i / 1, mapMid - i * 2, mapMouseX * i, 3);
		rotate((mouseX * 0.008));
		pop();
